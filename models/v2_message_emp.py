...
class EdgeMessagePassingLayer(torch.nn.Module):
    def __init__(self, emb_dim, hidden_dim, num_relations,input_layer=False):
        ...
        self.conv = RGCNConv(emb_dim, hidden_dim, num_relations)
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if num_bases is not None:
            ...
            self.weight = Parameter(
                torch.Tensor(num_relations, int(in_channels[0]*2), out_channels))
            self.register_parameter('comp', None)
